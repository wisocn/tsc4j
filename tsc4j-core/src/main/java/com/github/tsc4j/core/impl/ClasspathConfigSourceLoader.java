...
/**
 * {@link Tsc4jLoader} implementation that is able to bootstrap {@link ClasspathConfigSource}
 */
public final class ClasspathConfigSourceLoader extends AbstractTsc4jLoader<ClasspathConfigSource> {
    public ClasspathConfigSourceLoader() {
        super(ClasspathConfigSource.class, ClasspathConfigSource::builder,
            ClasspathConfigSource.TYPE,
            "Loads HOCON files from classpath folders.");
    }
}
