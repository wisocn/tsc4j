...
public final class BadConfigValueDecoder2 implements ConfigValueDecoder<InputStream> {
    public BadConfigValueDecoder2() {
        throw new IllegalStateException("I refuse to instantiate!");
    }
